...
export class User {
    ...
    constructor(client: MongoClient | undefined) {
        if (!client) throw new Error('MongoDB connection is lost. This could be because you refreshed the server by editing and saving code. Close the server and start again');
        this.client = client;
