...
import { categoriesFilterAdded } from '@/modules/events/events.multifilter.slice';
...
export default function NavItem({ title, index }: NavItemProps) {
    ...
    const handleClick = (title: string) => {
        ...
        //TODO: When a user had previously clicked on a sidebar item like 'Visit Page' and now they
